...
gasRetailPrice[, `:=` (new_york_city_gas_average_gal = as.numeric(new_york_city_average_gal), year = as.integer(year))]
...
1. Combine *weather* and *PM2.5* datasets into *master*.
...
master <- master[gasRetailPrice]
master <- master[dieselRetailPrice]
nrow(pm25)
...
2. Combine *master* and *weekly taxi* datasets.
