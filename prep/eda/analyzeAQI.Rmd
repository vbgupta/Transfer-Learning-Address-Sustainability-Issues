...
# Run EDA
#create_report(weather, output_file = "weather_eda.html", output_dir = "./eda/reports/")
```
...
pm25 <- pm25 %>% group_by(week, month, year) %>% summarise(avg_pm25 = mean(pm25), n = n())

View(pm25)

# Run EDA
# create_report(avgpm25, output_file = "avgpm25_eda.html", output_dir = "./eda/reports/") %>% try(TRUE)

#pm25 <- pm25[,by = .(week, Month, Year)]
```
