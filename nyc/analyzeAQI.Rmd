...
We will now store and save a data set of URLs.
```{r}
...
```{r}
yellowTaxiTripData2018 <- readRDS("C:/Users/divya_rustagi/Desktop/capstone/DS440-Transfer-Learning-Address-Sustainability-Issues/data/raw/yellowTaxiTripData2018.RDS")

nrow(yellowTaxiTripData2018)
head(yellowTaxiTripData2018)
```
